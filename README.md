...
committed and pushed to the main branch of the remote *CHOPStudy*
...
https://github.com/sjpierce/CHOPStudy. Private repositories are only
...
you have the GitHub account, send the *CHOPStudy* package maintainer
your GitHub username and ask to be added as a collaborator on the
repository. This is necessary because the main branch of the package
repository is stored on GitHub. You will need to be able to use Git and
...
generating dynamic reports (Mair, 2016). Install Quarto version 1.7.27
...
`C:\Users\username\AppData\Local\R\win-library\4.4\CHOPStudy` on your
...
- `CHOPStudy/`: This is the root folder for the repository.
  ...
  - `R/`: This folder contains the source code for the package’s custom
    ...
    - `CHOPStudy-package.R`: This script file is used to automate
...
you can load *CHOPStudy* via the following R console command. That
...
(2025). *Quarto* (Version 1.7.27) \[Computer Program\]. Posit Software,
