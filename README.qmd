...
incidence of bandemia in canine patients undergoing chemotherapy treatment. The
research team is led by Dr. Alison Masyr (PI) at Michigan State University.
...
reports [@Mair-RN3387]. Install Quarto version 1.7.21 or later. Although 
    ...
    * `scripts/` The folder is configured as a Quarto project. It holds 
      meta-data files, `.qmd` scripts, and files used by the scripts. 
        ...
        * `_quarto.yml`: This is a Quarto metadata file containing project-level 
          ...
          its subfolders.  
        * `Analyze_Data.qmd`: This script runs logistic regression models to be 
        ...
        * `Descriptive_Analysis.qmd`: This file runs some descriptive analyses 
          we plant o use in our manuscript. 
