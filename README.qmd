...
<!-- badges: start -->
[![Latest version DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18381003.svg)](https://doi.org/10.5281/zenodo.18381003)
      ...
      meta-data files, `.qmd` scripts, and files used by the scripts. 
        ...
        * `output/`: This subfolder holds rendered output files created by the 
          Quarto scripts in `scripts/`. 
            * `Descriptive_Analysis_2026-01-26.html` is final output we used in 
              the manuscript. 
