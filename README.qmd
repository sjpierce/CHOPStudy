...
[![CRAN status](https://www.r-pkg.org/badges/version/CHOPStudy)](https://CRAN.R-project.org/package=CHOPStudy)
<!-- badges: end -->

This package is a research compendium for a study examining the incidence of 
bandemia in canine patients undergoing chemotherapy treatment. The research team 
is led by Dr. Alison Masyr (PI) at Michigan State University. 
...
https://github.com/sjpierce/CHOPStudy. Private repositories are only visible 
...
You can get the most recent version of R from the 
...
version 2024.12.1+563 (or later). We recommend using RStudio to interact with
...
reports [@Mair-RN3387]. Install Quarto version 1.7.13 or later. Although 
...
in two places so your computer can find your PAT automatically.
...
If you previously were using an older version of R (any version in the 4.2.x or 
4.3.x series), you should plan to reinstall all your R packages from scratch
under R 4.4.0 or later. The best way to do that is to use a script such as
`scripts/Reinstall_Packages.R` under the older version to save a data file
...
`C:\Users\username\AppData\Local\R\win-library\4.4\CHOPStudy` on your laptop, 
...
parties outside the research team without Dr. Cunningham's approval. They should 
...
the `scripts/output` folder. It will also generate `scripts/Render_Scripts.pdf`, 
which is the log of running that rendering script and contains information on 
...
# Citing This Package
Please cite the package itself [@Pierce-RN8714], plus any associated data files. 
