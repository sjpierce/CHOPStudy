---
title: | 
  ![](../graphics/logo_MSU_CSTAT.png){width=3in style="margin-right: 55px;" fig-alt="Spartan helmet with MSU/CSTAT wordmark."}  
  ![](../graphics/CSTAT_5x5_Transparent.png){width=1.5in align="right" fig-alt="CSTAT logo."} \
  Example Script for Rendering HTML Output
author: 
